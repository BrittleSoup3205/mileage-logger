...
assert.match(serviceWorker, /mileage-logger-(?:active-trip-inspection-v54|multi-device-v5[6-9]|active-jobs-management-v5[8-9])/, "Offline cache must include the active-trip inspection fix or a newer release");

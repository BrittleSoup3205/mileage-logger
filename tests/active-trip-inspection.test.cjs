...
assert.match(serviceWorker, /mileage-logger-(?:active-trip-inspection-v54|multi-device-v5[6-9]|active-jobs-management-v5[8-9]|active-jobs-bootstrap-v59|active-jobs-open-status-v60|inspection-word-preview-v6[1-5]|full-upgrade-list-v66)/, "Offline cache must include the active-trip inspection fix or a newer release");

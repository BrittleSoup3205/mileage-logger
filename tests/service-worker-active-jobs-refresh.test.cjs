...
assert.match(source, /mileage-logger-full-upgrade-list-v67/, "Service worker cache version must advance so installed apps refresh assets");
assert.match(source, /active-jobs-management\.js\?v=reporting-vendor-header-1/, "Active Jobs management must use a new cache-busting asset URL");

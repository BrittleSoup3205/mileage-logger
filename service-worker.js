const CACHE_NAME = "mileage-logger-report-fixes-v114";
...
const TRIP_LOG_DESKTOP_ASSET = "./trip-log-desktop.js?v=responsive-log-5";
...
const INDEX_ASSET = "./index.html?v=report-fixes-40";

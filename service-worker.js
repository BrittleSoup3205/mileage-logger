const CACHE_NAME = "mileage-logger-report-fixes-v100";
...
const INSPECTION_DELETE_SYNC_FIX_ASSET = "./inspection-delete-sync-fix.js?v=explicit-delete-1";
...
const INDEX_ASSET = "./index.html?v=report-fixes-28";

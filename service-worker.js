...
async function injectRuntimeLoaders(response) {
  ...
  // These are intentionally appended after all legacy wrappers. The report-header
  // authoritative wrapper must be the final patchReport implementation used by
  // report-export-fixes, and the cloud refresh must capture export clicks at window level.

const CACHE_NAME = "mileage-logger-report-fixes-v103";
...
const TRIP_DUPLICATE_INTEGRITY_FIX_ASSET = "./trip-duplicate-integrity-fix.js?v=trip-dedupe-1";
...
const INDEX_ASSET = "./index.html?v=report-fixes-31";

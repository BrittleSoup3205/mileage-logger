const CACHE_NAME = "mileage-logger-report-fixes-v104";
...
const INTEGRITY_SYNC_FIX_ASSET = "./integrity-sync-fix.js?v=integrity-sync-1";
const TRIP_DUPLICATE_INTEGRITY_FIX_ASSET = "./trip-duplicate-integrity-fix.js?v=trip-dedupe-2";
const BACKUP_CHECKPOINT_SYNC_V2_ASSET = "./backup-checkpoint-sync-v2.js?v=backup-checkpoint-2";
...
const INDEX_ASSET = "./index.html?v=report-fixes-32";
...
async function injectRuntimeLoaders(response) {
  ...
  if (!html.includes("last-odometer-derived-fix.js")) {
    ...
    else html = appendScript(html, LAST_ODOMETER_FIX_ASSET);
  }
